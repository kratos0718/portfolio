...
export const projects = [
  ...
  {
    title: 'marimo',
    subtitle: 'Merged into marimo (YC-backed) · PR #9667 · New feature',
    description: 'Added filter parameter to file_browser component in marimo, the reactive Python notebook backed by Y Combinator. New feature contribution merged by maintainer @kirangadhave.',
