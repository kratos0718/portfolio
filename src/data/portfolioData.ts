...
export const projects = [
  {
    ...
    description: 'End-to-end AI placement prep platform with LLM pipelines for role-specific study material and mock interviews. RAG over FAISS/Pinecone for context-aware Q&A. Intelligent roadmap engine analyses skill gaps and auto-generates structured learning paths. Prompt engineering reduced token usage ~30%.',
  ...
  },
  {
    ...
    description: 'Triple-layer attendance verification combining real-time face recognition, GPS geo-fencing (100m radius), and rotating 6-digit session keys — eliminating proxy attendance entirely. Client-side face detection ensures biometric data never leaves the device. Deployed live at GITAM University with liveness detection to block photo spoofing.',
    tech: ['Python', 'JavaScript', 'Face Recognition', 'GPS Geo-fencing', 'Liveness Detection'],
    live: 'https://github.com/kratos0718/MarkMe',
    liveNow: false,
    github: 'https://github.com/kratos0718/MarkMe',
    year: '2025',
    challenge: 'Photo spoofing attacks — added liveness detection layer + rotating session keys to prevent replay attacks.',
  },
  {
    title: 'SoulSync',
    subtitle: 'AI Mental Health Chatbot · SIH 2024',
    description: 'Transformer-based emotion classification system delivering personalised emotional support. Fine-tuned sentence-transformer on mental-health-specific dataset boosted accuracy from 34% to 81%. Multi-label emotion scoring and context-aware multi-turn conversation tracking. Built for Smart India Hackathon 2024.',
